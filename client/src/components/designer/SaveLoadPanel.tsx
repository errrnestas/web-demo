          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            ...
            {plans?.map(plan => (
              <div key={plan.id}
                ...
                className="w-full text-left p-3 rounded-xl bg-slate-800 border border-slate-700 hover:border-blue-500 hover:bg-slate-700 transition-all group cursor-pointer">
