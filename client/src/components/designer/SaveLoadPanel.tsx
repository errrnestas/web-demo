      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md mx-4 flex flex-col shadow-2xl max-h-[80vh]">
        ...
        {tab === 'load' && (
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            ...
            {plans?.map(plan => (
              <button key={plan.id} onClick={() => handleLoad(plan)}
                className="w-full text-left p-3 rounded-xl bg-slate-800 border border-slate-700 hover:border-blue-500 hover:bg-slate-750 transition-all group">
